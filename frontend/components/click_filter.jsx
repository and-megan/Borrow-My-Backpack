      ...
      <div className="click-filter-all">
        ...
        <div className="click-filter-container">
          <div className="checkbox-label">
            <label className= "label-text" htmlFor="checkboxBa">Backpack</label>
          ...
          <br></br>
          <div className="checkbox-label">
            <label className= "label-text" htmlFor="checkboxBi">Bicycle</label>
          ...
          <br></br>
          <div className="checkbox-label">
            <label className= "label-text" htmlFor="checkboxKa">Kayak</label>
          ...
          <br></br>
          <div className="checkbox-label">
            <label className= "label-text" htmlFor="checkboxSn">Snowboard</label>
          ...
          <br></br>
          <div className="checkbox-label">
            <label className= "label-text" htmlFor="checkboxSu">Surfboard</label>
          ...
          <br></br>
          <div className="checkbox-label">
            <label className= "label-text" htmlFor="checkboxTe">Tent</label>
